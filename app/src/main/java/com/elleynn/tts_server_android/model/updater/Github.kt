...
object Github {
    private const val repo = "Elleynn/tts-server-android"
...
//        val assetsUrl: String = "", // https://api.github.com/repos/Elleynn/frpandroid/releases/117392218/assets
//        @SerialName("author")
...
//        @SerialName("html_url")
//        val htmlUrl: String = "", // https://github.com/Elleynn/frpandroid/releases/tag/1.23.081611
//        @SerialName("id")
...
//        val tarballUrl: String = "", // https://api.github.com/repos/Elleynn/frpandroid/tarball/1.23.081611
//        @SerialName("target_commitish")
//        val targetCommitish: String = "", // master
//        @SerialName("upload_url")
//        val uploadUrl: String = "", // https://uploads.github.com/repos/Elleynn/frpandroid/releases/117392218/assets{?name,label}
//        @SerialName("url")
//        val url: String = "", // https://api.github.com/repos/Elleynn/frpandroid/releases/117392218
//        @SerialName("zipball_url")
//        val zipballUrl: String = "" // https://api.github.com/repos/Elleynn/frpandroid/zipball/1.23.081611
    ) {
        @Serializable
        data class Asset(
            @SerialName("browser_download_url")
            val browserDownloadUrl: String = "", // https://github.com/Elleynn/frpandroid/releases/download/1.23.081611/AList-v1.23.081611.apk
...
//            @SerialName("url")
//            val url: String = "" // https://api.github.com/repos/Elleynn/frpandroid/releases/assets/121683040
        ) {
            @Serializable
            data class Uploader(
