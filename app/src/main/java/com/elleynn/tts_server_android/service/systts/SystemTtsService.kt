package com.elleynn.tts_server_android.service.systts
...
import com.elleynn.common.utils.limitLength
import com.elleynn.common.utils.longToast
import com.elleynn.common.utils.registerGlobalReceiver
import com.elleynn.common.utils.runOnUI
import com.elleynn.common.utils.sizeToReadable
import com.elleynn.common.utils.startForegroundCompat
import com.elleynn.common.utils.toHtmlBold
import com.elleynn.common.utils.toHtmlSmall
...
import com.elleynn.tts.MixSynthesizer
import com.elleynn.tts.SynthesizerConfig
import com.elleynn.tts.error.StreamProcessorError
import com.elleynn.tts.error.SynthesisError
...
import com.elleynn.tts.synthesizer.event.ErrorEvent
import com.elleynn.tts.synthesizer.event.Event
import com.elleynn.tts.synthesizer.event.IEventDispatcher
import com.elleynn.tts.synthesizer.event.NormalEvent
import com.elleynn.tts_server_android.R
import com.elleynn.tts_server_android.compose.MainActivity
import com.elleynn.tts_server_android.conf.SysTtsConfig
import com.elleynn.tts_server_android.constant.AppConst
import com.elleynn.tts_server_android.constant.SystemNotificationConst
import com.elleynn.tts_server_android.service.systts.SystemTtsService.Companion.ACTION_NOTIFY_CANCEL
import com.elleynn.tts_server_android.service.systts.SystemTtsService.Companion.ACTION_NOTIFY_KILL_PROCESS
import com.elleynn.tts_server_android.service.systts.SystemTtsService.Companion.ACTION_UPDATE_CONFIG
import com.elleynn.tts_server_android.service.systts.SystemTtsService.Companion.ACTION_UPDATE_REPLACER
import com.elleynn.tts_server_android.service.systts.SystemTtsService.Companion.NOTIFICATION_CHAN_ID
import com.elleynn.tts_server_android.service.systts.help.TextProcessor
        ...
        runBlocking {
            ...
            synthesizerJob = mScope.launch {
                mTtsManager?.synthesize(
                    ...
                    forceConfigId = cfgId,
                    callback = object :
                        com.elleynn.tts.synthesizer.SynthesisCallback {
