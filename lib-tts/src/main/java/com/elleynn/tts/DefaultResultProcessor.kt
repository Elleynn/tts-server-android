...
import com.elleynn.common.audio.AudioDecoder.Companion.readPcmChunk
import com.elleynn.common.audio.exo.ExoAudioDecoder
import com.elleynn.common.utils.rootCause
import com.elleynn.tts.error.StreamProcessorError
import com.elleynn.tts.error.StreamProcessorError.AudioDecoding
import com.elleynn.tts.error.StreamProcessorError.HandleError
import com.elleynn.tts.synthesizer.IResultProcessor
import com.elleynn.tts.synthesizer.PcmAudioDataListener
...
internal class DefaultResultProcessor(
    ...
    private val sonicAudioProcessor by lazy { com.elleynn.common.audio.exo.SonicAudioProcessor() }
